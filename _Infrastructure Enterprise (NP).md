...
conf t
 ...
 router ospf 1
  router-id 91.0.0.1
  network 91.0.0.1 0.0.0.0 area 91
  network 10.91.91.0 0.0.0.255 area 91
...
conf t
 router ospf 1
  router-id 10.91.91.4
   network 10.91.0.0 0.0.255.255 area 91
 int gi 0/1
  ip ospf network point-to-point
  end
~~~
...
conf t
 router ospf 1
  ...
  network 10.91.100.0 0.0.0.255 area 91
  end
~~~
...
!@CoreTAAS
config t
 hostname CoreTAAS-91-(PLDT)
 Track 1 Int gi 0/1 line-protocol
 int vlan 1
  standby 1 ip 10.91.1.16
  standby 1 preempt
